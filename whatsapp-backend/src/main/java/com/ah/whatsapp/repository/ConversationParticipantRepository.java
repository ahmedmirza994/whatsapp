...
public interface ConversationParticipantRepository {
	 ...
	 */
	Map<UUID, List<ConversationParticipant>> findParticipantsForConversationsAndIsActiveTrue(List<UUID> conversationIds);
	 ...
	 */
	Optional<ConversationParticipant> findByConversationIdAndUserIdAndIsActiveTrue(UUID conversationId, UUID userId);
