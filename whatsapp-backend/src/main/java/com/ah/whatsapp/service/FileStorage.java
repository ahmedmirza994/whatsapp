...
public interface FileStorage {
	 ...
	 */
	String storeFile(MultipartFile file, FolderName folderName, String baseFilename) throws IOException;
	 ...
	 */
	Resource loadFileAsResource(FolderName folderName, String filename) throws MalformedURLException;
}
