...
public class WebSocketConstants {
    ...
    public static final String CONVERSATION_TOPIC_TEMPLATE =
            TOPIC_PREFIX + CONVERSATIONS_TOPIC + "/%s"; // Template for specific conversation
    ...
    public static final String TYPING_INDICATOR_TOPIC = CONVERSATION_TOPIC_TEMPLATE + "/typing";
}
