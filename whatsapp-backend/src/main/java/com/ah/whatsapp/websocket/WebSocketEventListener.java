...
public class WebSocketEventListener {
	...
	public void handleNewMessage(NewMessageEvent event) {
		...
		WebSocketEvent<MessageDto> wsEvent = new WebSocketEvent<>(EventType.NEW_MESSAGE, messageDto);
		String destination = String.format(CONVERSATION_TOPIC_TEMPLATE, messageDto.conversationId());
	...
	public void handleConversationUpdate(ConversationUpdateEvent event) {
		...
		WebSocketEvent<ConversationDto> wsEvent = new WebSocketEvent<>(EventType.CONVERSATION_UPDATE, conversationDto);
	...
	public void handleMessageDeleted(MessageDeletedEvent event) {
		WebSocketEvent<DeleteMessageEvent> webSocketEvent = new WebSocketEvent<>(
