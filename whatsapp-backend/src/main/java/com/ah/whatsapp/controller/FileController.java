...
public class FileController {
	...
	public ResponseEntity<Resource> getProfilePicture(@PathVariable String filename, HttpServletRequest request) {
		log.debug("Request to get profile picture: {}", filename);
		try {
			Resource resource = fileStorage.loadFileAsResource(FolderName.PROFILE_PICTURES, filename);
